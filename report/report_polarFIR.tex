...
\begin{singlespace}
    \lstinputlisting[breaklines=true, label={lst:FIRunroll}, caption={FIR filter source code}, style=c-style, language=C++, firstnumber=54, linerange={54-59}]{../source/complexFIR.cpp}
\end{singlespace}
