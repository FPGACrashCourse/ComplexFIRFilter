...
We can apply the same concepts to the FIR filter

\subsubsection{Arbitrary precision}

The HLS environment offers the \codeword{ap_int.h} and \codeword{ap_fixed} libraries, which permit the creation of arbitrary-width integer and fixed-point datatypes.



\subsection{Optimization results}

Optimization performed to the algorithm has dramatically reduced the design's latency, and utilization
\end{document}
