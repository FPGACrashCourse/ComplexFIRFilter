...
/* Definitions for driver POLARFIR */
#define XPAR_XPOLARFIR_NUM_INSTANCES 1

/* Definitions for peripheral POLARFIR_0 */
#define XPAR_POLARFIR_0_DEVICE_ID 0
#define XPAR_POLARFIR_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_POLARFIR_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral POLARFIR_0 */
#define XPAR_XPOLARFIR_0_DEVICE_ID XPAR_POLARFIR_0_DEVICE_ID
#define XPAR_XPOLARFIR_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_XPOLARFIR_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF
